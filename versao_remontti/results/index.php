<?php
$WATERMARK_TEXT="Meu teste de velocidade";
...
$TEXT_COLOR_LABEL=imagecolorallocate($im,224,224,224);
$TEXT_COLOR_DL_METER=imagecolorallocate($im,0,230,118);
$TEXT_COLOR_UL_METER=imagecolorallocate($im,0,229,255);
$TEXT_COLOR_PING_METER=imagecolorallocate($im,255,145,0);
$TEXT_COLOR_JIT_METER=imagecolorallocate($im,255,145,0);
$TEXT_COLOR_MEASURE=imagecolorallocate($im,190,190,190);
$TEXT_COLOR_ISP=imagecolorallocate($im,188,188,188);
